...
#' in the paper.
#' 
#' Alternatively, for quick start for cases where the regulatory network has already been estimated, 
#' see the \code{domonster} function, which will take as input the two networks to compare, either 
#' as PANDA objects or as an adjacency matrix (matrix with regulators in rows and genes in columns)
#' 
